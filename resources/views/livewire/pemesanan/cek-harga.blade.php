                            ...
                            <tr class="text-center"   @if($item->status_barang_user == 2) style="background:rgb(248, 200, 200)" @endif>
                                ...
                                <td>
                                    @if ($item->status_barang_user == 1)
                                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalStatusBarang"  wire:click="setStatusBarang({{ $item->id }})"><i class="far fa-times-circle"></i></button>
                                    @else
                                        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalStatusBarang"  wire:click="setStatusBarang({{ $item->id }})"><i class="far fa-check-square"></i></button>
                                    @endif
                                </td>
                            </tr>
                            @endforeach

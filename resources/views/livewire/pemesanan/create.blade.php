        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-option float-right">
                    <button data-toggle="modal" data-target="#modalKeranjang" wire:click="kerangjangBelanja()" class="btn btn-info text-white" type="submit" style="width: 100%" > <strong><i class="fa fa-shopping-cart" aria-hidden="true"></i> Pesan Sekarang!</strong></button>
                </div>
            </div>
            <div class="card-body">
